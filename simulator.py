...
class RV64Simulator:
    def __init__(self, mem_size=128 * 1024 * 1024):
        ...
        # Single MMIO address for output:
    ...
    def execute(self, opcode, rd, funct3, rs1, rs2, funct7, imm_i, imm_s, imm_b, imm_u, imm_j):
        ...
        # RV64I 'W' Instructions (ADDIW, SLLIW, SRLIW, SRAIW)
        elif opcode == 0x1B:
            wmask = 0xFFFFFFFF
            if funct3 == 0x0:  # ADDIW
        ...
        # ECALL/EBREAK
            ...
            # In bare-metal mode, just ignore or print a warning
            # print("ECALL encountered in bare-metal mode, ignoring.")
            pass
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Bare-metal RISC-V RV64I Simulator")
